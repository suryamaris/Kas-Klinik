...
Public Class kMasuk
    ...
    Sub tampil()
        bukakoneksi()
        Dim da As New SqlDataAdapter("SELECT * FROM dbo.[kas] WHERE jenis ='Kas Masuk'", conn)
    ...
    Private Sub tambah_Click(sender As Object, e As EventArgs) Handles tambah.Click
        bukakoneksi()
        sql = "INSERT INTO dbo.[kas](tanggal,jenis,keterangan,jumlah) VALUES('" + tanggal.Text + "','Kas Masuk','" + keterangan.Text + "','" + jumlah.Text + "') "
